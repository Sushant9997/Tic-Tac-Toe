...
public class TicTacToe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(480, 175));
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        if(buttonused[0]==0)
        {
            if(turn%2==0)
            {
                ...
                int result2 = p2won();
                {
                    if(result1 ==1)
                    {
                        JOptionPane.showMessageDialog(reset, "Player 1 Won the Game!");
                    }
                    else if(result2 == 1)
                    {
                        JOptionPane.showMessageDialog(reset, "Player 2 Won the Game!");
                    }
                }
            }
            else
        ...
        {
            JOptionPane.showMessageDialog(reset, "This Button Is Already Used!");
        }
